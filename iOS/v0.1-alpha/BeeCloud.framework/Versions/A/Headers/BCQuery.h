...
/*!
 Sort the results in ascending order using the given key. Currently only sorting by one key is supported.
 @param key The key to order by.
 */
- (void)orderByAscending:(NSString *)key;

/*!
 Sort the results in descending order using the given key. Currently only sorting by one key is supported.
 @param key The key to order by.
 */
