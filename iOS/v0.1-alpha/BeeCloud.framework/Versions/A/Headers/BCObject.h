...
/*!
 The basic element for BeeCloud data storage. A BCObject can be considered as a row in MySQL table with objectId as key,
 and various columns.
 */
...
/*!
 Each object can be considered as a row in MySQL table and this class name is the table name. All classNames are lower
 case strings.
 */
